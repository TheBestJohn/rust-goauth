...
impl Scope {
  pub fn url(&self) -> String {
    match *self {
      Scope::Activity
        => String::from("https://www.googleapis.com/auth/activity"),
      ...
      Scope::AdminDirectoryDeviceChromeOsReadOnly
        => String::from("https://www.googleapis.com/auth/admin.directory.device.chromeos.readonly"),
      ...
      Scope::AdminDirectoryDeviceMobileReadOnly
        => String::from("https://www.googleapis.com/auth/admin.directory.device.mobile.readonly"),
      ...
      Scope::AdminDirectoryGroupMemberReadOnly
        => String::from("https://www.googleapis.com/auth/admin.directory.group.member.readonly"),
      ...
      Scope::AdminDirectoryResourceCalendarReadOnly
        => String::from("https://www.googleapis.com/auth/admin.directory.resource.calendar.readonly"),
      ...
      Scope::AdminDirectoryRoleManagementReadOnly
        => String::from("https://www.googleapis.com/auth/admin.directory.rolemanagement.readonly"),
      ...
      Scope::AdSense
        => String::from("https://www.googleapis.com/auth/adsense"),
      Scope::AdSenseHost
        => String::from("https://www.googleapis.com/auth/adsensehost"),
      Scope::AdSenseReadOnly
        => String::from("https://www.googleapis.com/auth/adsense.readonly"),
      Scope::Analytics
        => String::from("https://www.googleapis.com/auth/analytics"),
      Scope::AnalyticsEdit
        => String::from("https://www.googleapis.com/auth/analytics.edit"),
      ...
      Scope::AppsLicensing
        => String::from("https://www.googleapis.com/auth/apps.licensing"),
      Scope::AppsOrder
        => String::from("https://www.googleapis.com/auth/apps.order"),
      ...
      Scope::Blogger
        => String::from("https://www.googleapis.com/auth/blogger"),
      Scope::BloggerReadOnly
        => String::from("https://www.googleapis.com/auth/blogger.readonly"),
      Scope::Books
        => String::from("https://www.googleapis.com/auth/books"),
      Scope::Calendar
        => String::from("https://www.googleapis.com/auth/calendar"),
      Scope::CalendarFeeds
        => String::from("https://www.google.com/calendar/feeds"),
      ...
      Scope::ClassroomCourseworkStudentsReadOnly
        => String::from("https://www.googleapis.com/auth/classroom.coursework.students.readonly"),
      ...
      Scope::ClassroomStudentSubmissionsMeReadOnly
        => String::from("https://www.googleapis.com/auth/classroom.student-submissions.me.readonly"),
      Scope::ClassroomStudentSubmissionsStudentsReadOnly
        => String::from("https://www.googleapis.com/auth/classroom.student-submissions.students.readonly"),
      Scope::CloudDebugger
        => String::from("https://www.googleapis.com/auth/cloud_debugger"),
      Scope::CloudPlatform
        => String::from("https://www.googleapis.com/auth/cloud-platform"),
      ...
      Scope::Compute
        => String::from("https://www.googleapis.com/auth/compute"),
      Scope::ComputeReadOnly
        => String::from("https://www.googleapis.com/auth/compute.readonly"),
      Scope::Contacts
        => String::from("https://www.googleapis.com/auth/contacts"),
      Scope::ContactsReadOnly
        => String::from("https://www.googleapis.com/auth/contacts.readonly"),
      Scope::Content
        => String::from("https://www.googleapis.com/auth/content"),
      Scope::DataStore
        => String::from("https://www.googleapis.com/auth/datastore"),
      Scope::Ddmconversions
        => String::from("https://www.googleapis.com/auth/ddmconversions"),
      ...
      Scope::Dfareporting
        => String::from("https://www.googleapis.com/auth/dfareporting"),
      Scope::Dfatrafficking
        => String::from("https://www.googleapis.com/auth/dfatrafficking"),
      ...
      Scope::DriveAppdata
        => String::from("https://www.googleapis.com/auth/drive.appdata"),
      Scope::DriveFile
        => String::from("https://www.googleapis.com/auth/drive.file"),
      Scope::DriveMetadata
        => String::from("https://www.googleapis.com/auth/drive.metadata"),
      ...
      Scope::DriveReadOnly
        => String::from("https://www.googleapis.com/auth/drive.readonly"),
      Scope::DriveScripts
        => String::from("https://www.googleapis.com/auth/drive.scripts"),
      Scope::Firebase
        => String::from("https://www.googleapis.com/auth/firebase"),
      Scope::FirebaseMessaging
      ...
      Scope::Forms
        => String::from("https://www.googleapis.com/auth/forms"),
      Scope::FormsCurrentOnly
        => String::from("https://www.googleapis.com/auth/forms.currentonly"),
      Scope::FusionTables
        => String::from("https://www.googleapis.com/auth/fusiontables"),
      Scope::FusionTablesReadOnly
        => String::from("https://www.googleapis.com/auth/fusiontables.readonly"),
      Scope::Games
        => String::from("https://www.googleapis.com/auth/games"),
      Scope::Genomics
        => String::from("https://www.googleapis.com/auth/genomics"),
      Scope::GenomicsReadOnly
        => String::from("https://www.googleapis.com/auth/genomics.readonly"),
      Scope::GlassLocation
        => String::from("https://www.googleapis.com/auth/glass.location"),
      Scope::GlassTimeline
        => String::from("https://www.googleapis.com/auth/glass.timeline"),
      Scope::Gmail
        => String::from("https://mail.google.com/"),
      Scope::GmailCompose
        => String::from("https://www.googleapis.com/auth/gmail.compose"),
      Scope::GmailInsert
        => String::from("https://www.googleapis.com/auth/gmail.insert"),
      Scope::GmailLabels
        => String::from("https://www.googleapis.com/auth/gmail.labels"),
      Scope::GmailMetadata
        => String::from("https://www.googleapis.com/auth/gmail.metadata"),
      Scope::GmailModify
        => String::from("https://www.googleapis.com/auth/gmail.modify"),
      Scope::GmailReadOnly
        => String::from("https://www.googleapis.com/auth/gmail.readonly"),
      Scope::GmailSend
        => String::from("https://www.googleapis.com/auth/gmail.send"),
      ...
      Scope::Groups
        => String::from("https://www.googleapis.com/auth/groups"),
      Scope::LoggingAdmin
        => String::from("https://www.googleapis.com/auth/logging.admin"),
      Scope::LoggingRead
        => String::from("https://www.googleapis.com/auth/logging.read"),
      Scope::LoggingWrite
        => String::from("https://www.googleapis.com/auth/logging.write"),
      Scope::M8Feeds
        => String::from("https://www.google.com/m8/feeds"),
      Scope::ManufacturerCenter
        => String::from("https://www.googleapis.com/auth/manufacturercenter"),
      Scope::Monitoring
        => String::from("https://www.googleapis.com/auth/monitoring"),
      ...
      Scope::NdevCloudman
        => String::from("https://www.googleapis.com/auth/ndev.cloudman"),
      ...
      Scope::PlusLogin
        => String::from("https://www.googleapis.com/auth/plus.login"),
      Scope::PlusMe
        => String::from("https://www.googleapis.com/auth/plus.me"),
      ...
      Scope::Prediction
        => String::from("https://www.googleapis.com/auth/prediction"),
      Scope::Presentations
        => String::from("https://www.googleapis.com/auth/presentations"),
      Scope::PresentationsReadOnly
        => String::from("https://www.googleapis.com/auth/presentations.readonly"),
      Scope::PubSub
        => String::from("https://www.googleapis.com/auth/pubsub"),
      Scope::ReplicaPool
        => String::from("https://www.googleapis.com/auth/replicapool"),
      Scope::ReplicaPoolReadOnly
        => String::from("https://www.googleapis.com/auth/replicapool.readonly"),
      Scope::Servicecontrol
        => String::from("https://www.googleapis.com/auth/servicecontrol"),
      ...
      Scope::SpreadSheets
        => String::from("https://www.googleapis.com/auth/spreadsheets"),
      ...
      Scope::TaskQueue
        => String::from("https://www.googleapis.com/auth/taskqueue"),
      Scope::TaskQueueConsumer
        => String::from("https://www.googleapis.com/auth/taskqueue.consumer"),
      Scope::Tasks
        => String::from("https://www.googleapis.com/auth/tasks"),
      Scope::TasksReadOnly
        => String::from("https://www.googleapis.com/auth/tasks.readonly"),
      Scope::TraceAppend
        => String::from("https://www.googleapis.com/auth/trace.append"),
      Scope::TraceReadOnly
        => String::from("https://www.googleapis.com/auth/trace.readonly"),
      Scope::URLShortener
        => String::from("https://www.googleapis.com/auth/urlshortener"),
      ...
      Scope::WebMasters
        => String::from("https://www.googleapis.com/auth/webmasters"),
      Scope::WebMastersReadOnly
        => String::from("https://www.googleapis.com/auth/webmasters.readonly"),
      Scope::YouTube
        => String::from("https://www.googleapis.com/auth/youtube"),
      ...
      Scope::YouTubepartner
        => String::from("https://www.googleapis.com/auth/youtubepartner"),
      ...
      Scope::YouTubeUpload
        => String::from("https://www.googleapis.com/auth/youtube.upload")
    }
  }
}
